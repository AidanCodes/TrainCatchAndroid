...
public class MainActivity extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final Button btnStart = findViewById(R.id.btnDest);
        ...
        final Button btnDest = findViewById(R.id.btnDest);
    ...
    public void openStartAct() {
        Intent locAct = new Intent(getApplicationContext(), LocationActivity.class);
        startActivity(locAct);
    }

    public void openDestAct() {
        Intent locAct = new Intent(getApplicationContext(), LocationActivity.class);
        startActivity(locAct);
    }
